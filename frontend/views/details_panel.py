...
class DetailsPanel(QWidget):
    ...
    def setup_ui(self):
        ...
        self.libelle_court_label.setWordWrap(True)
        self.libelle_long_label = QLabel()
        self.libelle_long_label.setWordWrap(True)
        ...
        self.feuille_catalogue_label.setWordWrap(True)
        self.description_feuille_catalogue_label = QLabel()
        self.description_feuille_catalogue_label.setWordWrap(True)
